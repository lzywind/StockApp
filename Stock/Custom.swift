...
class Custom: UITableViewController {

    @IBOutlet var TableViewD: UITableView!
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TableDCell", for: indexPath) as! TableViewCellD
